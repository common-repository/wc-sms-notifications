                        ...
                        <tbody>
                                                ...
                                                <td style="padding-top:25px;padding-right:20px;padding-left:20px;padding-bottom:20px;border-right:1px solid #dddddd;border-left:1px solid #dddddd;border-bottom:1px solid #dddddd">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="padding-top:5px;padding-bottom:10px;font-weight:normal;font-size:16px;line-height:26px;color:#6f8996">If you are happy with our services, please give us a <a href="https://wordpress.org/support/plugin/wc-sms-notifications/reviews/#postform" style="text-decoration:none;color: #48a9f9;">★★★★★</a>, to help us encourage and develop more features and integrations.</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                ...
                                                                <td align="center" style="padding-top:10px;padding-bottom:17px">
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <center><a href="https://www.wcsmsn.co.in/#pricebox" style="background:#03a9f4;border-radius:3px;color:#ffffff;display:block;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;letter-spacing:1px;padding:14px 8px;text-decoration:none" target="_blank">BUY CREDIT </a></center>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                            ...
                            <tr>
                                <td bgcolor="#fafafa" align="center" style="font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;font-size:16px;line-height:32px;color:#9fb1c1">
                                    <br />You are receving this email because you have subscribed to low balance alert. You may update your email preferences <a href="'.$admin_url.'admin.php?page=wc-settings&tab=wcsmsn#customertemplates" style="color:#03a9f4;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;text-decoration:none" target="_blank">here</a>.</td>
                            </tr>
                            <tr>
                                <td bgcolor="#fafafa" align="center" style="padding:25px 20px;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;font-size:12px;line-height:16px;color:#9fb1c1"><img alt="WC SMS Notifications" src="https://www.wcsmsn.co.in/logo/www.wcsmsn.co.in.png" style="padding-bottom:20px;" width="120">
                                    <br><a style="color:#9fb1c1;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;text-decoration:none"> &copy; 2017 www.wcsmsn.co.in. a venture of www.cozyvision.com, 1023, The Ithum Tower-B Plot No. A-40, Sector-62, Noida Uttar Pradesh - 201301</a></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
